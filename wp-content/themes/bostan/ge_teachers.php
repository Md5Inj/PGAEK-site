<?php
/*
Template Name: General education teachers
*/
?>
<?php get_header(); ?>
<!-- post title holder -->
...
<?php
  ...
  if (get_post_meta($post->ID, 'asalah_portfolio_page_tag', true) != '') {
	...
	$wp_query = new WP_Query(array('post_type' => 'team', 'paged' => get_query_var( 'paged' ), 'posts_per_page' => 8, 'tagportfolio' => $tags_array, 'category_name' => "преподаватели-цк-од"));
?>
