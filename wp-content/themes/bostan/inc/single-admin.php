                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class('project_post row-fluid team-single'); ?>>
                    <div class="span4 "> <!-- portfolio_banner blog_main_content -->
                      ...
                      <?php if ($get_meta['asalah_admin_gp'][0] != '') { ?>
                                          <p><strong>Педагогический стаж: </strong><?php echo $get_meta['asalah_admin_gp'][0]; ?></p></li>
                                      <?php } ?>
                                      <?php if ($get_meta['asalah_admin_yt'][0] != '') { ?>
                                          <p><strong>Кабинет: </strong><?php echo $get_meta['asalah_admin_yt'][0]; ?></p></li>
                                      <?php } ?>
                    </div>
