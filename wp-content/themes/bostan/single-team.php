                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class('project_post row-fluid team-single'); ?>>
                    <div class="span4 "> <!-- portfolio_banner blog_main_content -->
                      <?php asalah_blog_thumb(); ?> <br> <br>
                                    ...
                                    <div class="team_position"><strong>Должность: </strong><?php echo $get_meta['asalah_team_position'][0]; ?></div>
                                <?php endif; ?>
                                <?php if ($get_meta['asalah_team_fb'][0] != '') { ?>
                                          <p><strong>Образование: </strong><?php echo $get_meta['asalah_team_fb'][0]; ?></p></li>
                                      <?php } ?>
                                      <?php if ($get_meta['asalah_team_tw'][0] != '') { ?>
                                          <p><strong>Категория: </strong><?php echo $get_meta['asalah_team_tw'][0]; ?></p></li>
                                      <?php } ?>
                      <?php if ($get_meta['asalah_team_gp'][0] != '') { ?>
                                          <p><strong>Педагогический стаж: </strong><?php echo $get_meta['asalah_team_gp'][0]; ?></p></li>
                                      <?php } ?>
                                      <?php if ($get_meta['asalah_team_yt'][0] != '') { ?>
                                          <p><strong>Кабинет: </strong><?php echo $get_meta['asalah_team_yt'][0]; ?></p></li>
                                      <?php } ?>
                    </div>
