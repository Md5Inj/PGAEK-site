        ...
        function j() {
            if (B == 8 || B == 7 || B == 6 || B == 5) {
                ...
                if (Cookies.get("bvi-panel-active") === "true") {
                    a(r).hide().after(a('<div class="header-icon bvi-link bvi-open bt_widget-vi-on bvi-panel-close" style="text-align: center; padding: 30px 0px 30px 30px; display: block;">\n' +
                        '    <div>\n' +
                        '        <i class="bvi-icon bvi-eye bvi-2x"></i>\n' +
                        '    </div>\n' +
                        '    <div>\n' +
                        '        <span class="">Обычная версия сайта</span>\n' +
                        '    </div>\n' +
                        '</div>'));
                    n();
                    w();
